                ...
                <TableCell>
                  <div className="flex items-center gap-1">
                    {order.status !== 'completado' && (
                      <button onClick={() => { handleCompleteOrder(order.id); }} aria-label="Completar orden" className="rounded p-1 text-[var(--text-secondary)] hover:bg-white/5 hover:text-green-400 transition-colors cursor-pointer" title="Completar">
                        <CheckCircle2 size={16} />
                      </button>
                    )}
                    <button onClick={() => openEdit(order)} aria-label="Editar orden" className="rounded p-1 text-[var(--text-secondary)] hover:bg-white/5 hover:text-blue-400 transition-colors cursor-pointer" title="Editar">
                      <Wrench size={16} />
                    </button>
                    <button onClick={() => { handleDeleteOrder(order.id); }} aria-label="Eliminar orden" className="rounded p-1 text-[var(--text-secondary)] hover:bg-white/5 hover:text-red-400 transition-colors cursor-pointer" title="Eliminar">
