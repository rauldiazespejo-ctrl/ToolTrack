              ...
              <TableRow key={eq.id} onClick={() => void navigate(`/equipment/${eq.id}`)}>
                ...
                <TableCell>
                  <div className="flex items-center gap-1" onClick={e => e.stopPropagation()}>
                    <Button variant="ghost" size="sm" onClick={() => openEdit(eq)} aria-label="Editar equipo">
                      <Pencil size={14} />
                    </Button>
                    <Button variant="ghost" size="sm" onClick={() => setDeleteConfirm(eq.id)} aria-label="Eliminar equipo">
