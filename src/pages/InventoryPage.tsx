              ...
              <TableRow key={item.id} className={isLow ? 'bg-red-500/5' : ''}>
                ...
                <TableCell>
                  <div className="flex items-center gap-1">
                    <button onClick={() => openAdjust(item)} className="rounded p-1 text-[var(--text-secondary)] hover:bg-white/5 hover:text-green-400 transition-colors cursor-pointer focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--accent)]" title="Ajustar stock" aria-label="Ajustar stock">
                      <ArrowUpCircle size={16} />
                    </button>
                    <button onClick={() => openEdit(item)} className="rounded p-1 text-[var(--text-secondary)] hover:bg-white/5 hover:text-blue-400 transition-colors cursor-pointer focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--accent)]" title="Editar" aria-label="Editar item">
                      <Edit2 size={16} />
                    </button>
                    <button onClick={() => { void handleDeleteItem(item.id); }} className="rounded p-1 text-[var(--text-secondary)] hover:bg-white/5 hover:text-red-400 transition-colors cursor-pointer focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--accent)]" title="Eliminar" aria-label="Eliminar item">
                      <Trash2 size={16} />
                    </button>
                  </div>
                </TableCell>
