              ...
              <TableRow key={item.id} className={isLow ? 'bg-red-500/5' : ''}>
                ...
                <TableCell>
                  <div className="flex items-center gap-1">
                    <button onClick={() => openAdjust(item)} aria-label="Ajustar stock" className="rounded p-1 text-[var(--text-secondary)] hover:bg-white/5 hover:text-green-400 transition-colors cursor-pointer" title="Ajustar stock">
                      <ArrowUpCircle size={16} />
                    </button>
                    <button onClick={() => openEdit(item)} aria-label="Editar item" className="rounded p-1 text-[var(--text-secondary)] hover:bg-white/5 hover:text-blue-400 transition-colors cursor-pointer" title="Editar">
                      <Edit2 size={16} />
                    </button>
                    <button onClick={() => { void handleDeleteItem(item.id); }} aria-label="Eliminar item" className="rounded p-1 text-[var(--text-secondary)] hover:bg-white/5 hover:text-red-400 transition-colors cursor-pointer" title="Eliminar">
                      <Trash2 size={16} />
                    </button>
                  </div>
                </TableCell>
