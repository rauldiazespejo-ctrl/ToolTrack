      ...
      <div className="flex items-center gap-4">
        <div className="relative hidden md:block">
          ...
          <input
            ...
            aria-label="Buscar equipos e inventario"
            value={inputValue}
        ...
        <button aria-label="Notificaciones" className="relative rounded-lg p-2 text-[var(--text-secondary)] hover:bg-white/5 hover:text-[var(--text-primary)] transition-colors cursor-pointer">
          <Bell size={20} />
